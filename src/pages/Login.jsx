...
const Login = () => {
  ...
  // ✅ QUICK LOGIN BY ROLE (No functionality - just UI)
  const handleQuickLogin = (role) => {
    toast.info(`🔒 Quick login as ${role} coming soon!`, {
      position: 'top-right',
      autoClose: 2000,
    });
  };
        ...
        <div className="login-right">
          <div className="login-form-container">
            ...
            <div className="login-header">
              ...
              <p>{isSignUp ? 'Sign up to get started' : 'Select your role to continue to Tasty Station'}</p>
            </div>
            ...
            {/* ✅ QUICK LOGIN SECTION - Role Based Buttons */}
            {!isSignUp && (
              <div className="quick-login-section">
                ...
                <div className="role-buttons-grid">
                  ...
                  <button 
                    type="button" 
                    className="role-btn role-waiter"
                  ...
                  <button 
                    type="button" 
                    className="role-btn role-customer"
